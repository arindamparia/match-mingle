package com.arindamcreates.matchmingle.constant;

public class Constants {
  public static final String USER_LOCKED = "User is locked";
  public static final String USER_UNLOCKED = "User is unlocked";
  public static final String USER_ALREADY_LOCKED = "User is already locked";
  public static final String USER_ALREADY_UNLOCKED = "User is already unlocked";
  ...
  public static final String CANNOT_SELF_DENY = "Cannot deny request from self";
  public static final String CANNOT_SELF_REMOVE = "Cannot remove request from self";
